...
export const STUDY_MODELS = Object.freeze({
  'gpt-5.6-sol': { provider: 'openai', label: 'GPT-5.6 Sol', input: 4, output: 20, cacheWriteMultiplier: 1.25, longContextThreshold: 272000 },
  'gpt-6-sol': { provider: 'openai', label: 'GPT-6 Sol', input: 2, output: 10, cacheWriteMultiplier: 1.25, longContextThreshold: 272000 },
  'gpt-6-astra': { provider: 'openai', label: 'GPT-6 Astra', input: 10, output: 50, cacheWriteMultiplier: 1.25, longContextThreshold: 272000 },
