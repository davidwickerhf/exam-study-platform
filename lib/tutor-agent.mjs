...
export const TUTOR_HANDLERS = {
  ...
  async get_announcements({ days = 21, courseCode = '', query = '', limit = 5 }) {
    return readCourseAnnouncements({ days, courseCode, query, limit: Math.min(8, Math.max(1, Number(limit) || 5)) })
  },
