...
export async function createStudyVersion(
  ...
  programmeId,
  snapshot,
  { title = '', parent = null, billing = null, execution = 'hosted', automation = null, id: requestedId = null } = {}
) {
  ...
  const version = {
    ...
    draft: { ...newStudyDraft(snapshot, billing), ...(automation ? {stage:'readiness',moduleCandidate:automation.candidate} : {}), execution, status: execution === 'local' ? 'local-ready' : 'queued' },
    visibility: 'private',
    review: 'unreviewed'
  }
