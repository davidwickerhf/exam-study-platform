 ...
 *
 * Plain ESM with a .d.mts beside it, for the same reason as lib/v2/account.mjs:
...
export function attentionQueue({ editions = [], requests = [] } = {}) {
  ...
  for (const edition of editions) {
    ...
    items.push({
      ...
      detail: stage.next,
      href: `/v2/admin?tab=production&edition=${encodeURIComponent(String(edition.id))}`,
