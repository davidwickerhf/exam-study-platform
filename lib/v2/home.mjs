 ...
 *
 * These rules are duplicated from public/app.js for the length of the
 * migration: the vanilla bundle is a classic script and cannot import a
 * module, so both copies exist and both are tested. The vanilla copy dies with
 * the file.
 */
