...
Return this shape:
{"courseProfile":{"description":"","learningOutcomes":[],"prerequisites":[],"teachingFormat":[],"assessment":{"status":"confirmed|needs-review|not-found","components":[{"name":"","type":"exam|project|presentation|assignment|participation|other","weightPercent":null,"minimumPercent":null,"deadline":null,"deadlineText":"","notes":"","evidence":[{"chunkId":1,"assetId":"","page":1,"note":""}]}],"overallPassRules":[],"resitRules":[],"attendanceRules":[],"conflicts":[]}},"chapters":[{"stableKey":"short-stable-slug","title":"","summary":"","sourceChunkIds":[1],"concepts":[{"stableKey":"short-stable-slug","title":"","summary":"","sourceChunkIds":[1]}]}]}
...
async function chapterEvidence(editionId, chapter) {
  return sql`SELECT DISTINCT r.id, r.asset_id, r.page_number, r.content, a.filename
...
async function processGenerationJob(job, edition, generate) {
  ...
  const rows = await chapterEvidence(edition.id, topic)
