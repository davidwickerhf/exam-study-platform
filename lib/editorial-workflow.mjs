...
export async function extractOffice(bytes, extension) {
  ...
  try {
    ...
    const { stdout } = await execFileAsync('python3', [new URL('../scripts/extract-course-text.py', import.meta.url).pathname, file, 'source.pptx'], { maxBuffer: 64 * 1024 * 1024, timeout: 90000 })
