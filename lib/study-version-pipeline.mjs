    ...
    if (work.stage === 'readiness') {
      ...
      if (topic) {
        ...
        if (work.structuralFill?.topicId === topic.id) {
          ...
          const savedFailure=work.planSemanticChecks?.[topic.id]?.status==='failed' && work.planSemanticChecks[topic.id].version===STUDY_PLAN_PRECHECK_VERSION ? work.planSemanticChecks[topic.id].findings : null
