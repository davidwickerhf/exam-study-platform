...
import {courseBundlePolicy,budgetSummary,teachingRoles,attachSupporting,assertChapterBudget,outlinePlanningStale,COURSE_BUNDLE_PLANNING_POLICY} from './study-course-scope-policy.mjs'
...
export function normalizeStudyOutline(result, snapshot, previous = [], course, policy = null) {
  ...
  if (policy && result.guides?.length) assertChapterBudget(result, expanded, expansion, policy)
