...
import { studyPlanPrecheckStep, semanticPlanRetryPrompt, STUDY_PLAN_PRECHECK_VERSION } from './study-plan-precheck.mjs'
    ...
    if (work.stage === 'readiness') {
      ...
      if (topic) {
        ...
        if (work.structuralFill?.topicId === topic.id) {
          ...
          const planPrompt=semantic
            ? semanticPlanRetryPrompt(evidence,pending.proposal,pending.issues)
