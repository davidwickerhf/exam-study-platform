      ...
      if (chapter) {
        ...
        if (!chapter.evidenceReview) {
          ...
          const result = parseStudyJson(await generate(
            ...
            { ...options, responseSchema: pedagogicalResponseSchema(chapter), stage: 'quality', reasoningEffort: 'medium', maxOutputTokens: 10000, usageMetadata: { ...options.usageMetadata, chapterId: topic.id, phase: 'pedagogical-review' } }
