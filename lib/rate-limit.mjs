...
export function classifyRequest(method, pathname) {
  ...
  if (pathname === '/api/academics/documents/analyze' || pathname === '/api/academics/intake/analyze') return 'upload'
  if (['/api/chat', '/api/grade'].includes(pathname) || /\/extend$/.test(pathname) || /\/flashcards\/[^/]+\/[^/]+\/[^/]+\/grade$/.test(pathname)) return 'ai'
