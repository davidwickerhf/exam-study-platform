...
export const AGENT_MANIFEST = Object.freeze({
  ...
  endpoints: [
    ...
    { method: 'POST', path: '/api/course-content-requests', scope: 'write', body: '{ academicCourseId, categories?, notes?, urls?, files?: [{ name, type, base64 }] }', summary: 'Request maintained content for a course in the caller’s academic record and privately submit supporting materials.' },
