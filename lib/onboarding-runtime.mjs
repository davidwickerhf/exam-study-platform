...
export async function finishSetup() {
  ...
  if (!conversation.finished) {
    ...
    conversation.summary = conversation.summary || `Setup finished from the checklist. ${state.programmeName || 'Your programme'} is recorded with ${state.courseCount} course${state.courseCount === 1 ? '' : 's'}.`
