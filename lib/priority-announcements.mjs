...
export async function refreshPriorityAnnouncements({binding,accountId,assertActive=()=>{},commit=null,rows:suppliedRows=null}) {
  ...
  if(!rows) {
    ...
    rows = await api.getPaged(`/api/v1/courses/${encodeURIComponent(binding.canvas_course_id)}/discussion_topics?only_announcements=true&per_page=100`)
  }
