    ...
    courses: (state?.courses || []).map((course) => ({
      ...
      courseProfile: course.courseProfile ? {
        assessment: course.courseProfile.assessment ? {
          ...
          ...((course.courseProfile.assessment.attendanceEvidence || []).length ? { attendanceEvidence: course.courseProfile.assessment.attendanceEvidence.map((rule) => ({
              text: rule.text,
              activity: rule.activity,
              allowedMisses: rule.allowedMisses ?? null,
              minimumAttendancePercent: rule.minimumAttendancePercent ?? null,
              excusedPolicy: rule.excusedPolicy || '',
