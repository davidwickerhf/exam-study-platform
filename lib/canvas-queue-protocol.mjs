...
export const STUDY_QUEUE_TOPIC = 'study-generation-v1'
export function queueTopicForJob(jobId) {
  return jobId.startsWith('sv-') ? STUDY_QUEUE_TOPIC : CANVAS_QUEUE_TOPIC
}
