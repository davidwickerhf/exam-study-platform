...
import { studyProviderError, providerErrorCode, PROVIDER_OUTPUT_LIMIT_MESSAGE } from './study-provider-errors.mjs'
...
function classifyAgentFailure(error,{usage,requestId,responseId,incompleteReason,deadline,callDeadlineMs,callerAborted}) {
  ...
  if(incompleteReason==='max_output_tokens') {
    const limited=new StudyVersionError(PROVIDER_OUTPUT_LIMIT_MESSAGE,502)
