...
// Read-only, bounded look-ahead. Reuses the page cache; never starts AI or a sync.
export const TOUR_PREFETCH = Object.freeze({
  '/app/courses': ['/api/academics', '/api/workspace-shell', '/api/onboarding/programmes?view=workspace'],
  '/app/practice': ['/api/practice'],
  '/app/calendar': ['/api/calendar/events', '/api/academics'],
  '/app/planning': ['/api/academics'],
  '/app/documents': ['/api/academics/work', '/api/academics/document-records'],
  '/app/tutor': ['/api/tutor?view=chat'],
})
