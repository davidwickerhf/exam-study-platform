...
export type AcademicCourse = { id?: string; code: string; name?: string; period?: string; yearLevel?: string; attempts?: { examDate?: string | null; type?: string | null; status?: string | null }[] }
