...
function guidePolicyEnabled(row,automation) {
  return automation.kind==='maintenance' ? row?.maintainedGuides?.some(g=>g.enabled&&g.versionId===automation.versionId&&JSON.stringify(g.moduleRefs)===JSON.stringify(automation.candidate.moduleRefs)) : row?.settings.enabled
}
