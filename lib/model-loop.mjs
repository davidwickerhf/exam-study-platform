...
export async function callModel(messages, { tools = [], toolChoice = 'auto', maxOutputTokens = 1400, responseFormat = null, signal, reasoningEffort = null, model: requestedModel = null, onContent } = {}) {
