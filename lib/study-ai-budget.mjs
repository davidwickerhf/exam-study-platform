...
export function estimateStudyProduction(snapshot, billing) {
  ...
  const estimate = (chapters) => {
    const input = chars / 3 + chapters * 26000 + batches * 1500,
      output = batches * 1800 + chapters * 14000
