...
export async function canvasCorpusStatus({ accountId } = {}) {
  ...
  const courses = await sql`SELECT b.id, b.edition_id, b.canonical_course_id, b.course_code, b.course_name, b.academic_year, b.period, b.last_synced_at, b.next_sync_at,
