...
export const MCP_LIMITS=Object.freeze({requestBytes:4*1024*1024,resultBytes:2*1024*1024,requestsPerMinute:60,concurrentRequests:4,tokenUnitsPerMinute:12_000_000,tokenUnitsPerDay:64_000_000})
