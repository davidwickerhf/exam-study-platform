...
const phases=new Set(['source-mapping','course-outline','teaching-plan','teaching-plan-check','teaching-plan-arbiter','authoring','structural-fill','pedagogical-precheck','factual-review','pedagogical-review','correction','question-correction'])
