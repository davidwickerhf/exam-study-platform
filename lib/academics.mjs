...
export function emptyAcademicWorkspace() {
  return {
    ...
    events: [],
    gates: [],
    planning: { objectives: {}, periodAssignments: [], academicPeriods: [], attendanceRecords: [] },
    calendars: []
  }
}
...
function planningFromStored(value) {
  if (!value || typeof value !== 'object' || Array.isArray(value)) return { objectives: {}, periodAssignments: [], academicPeriods: [], attendanceRecords: [] }
  ...
  return { objectives: value, periodAssignments: [], academicPeriods: [], attendanceRecords: [] }
}
...
export function normalizeAcademicWorkspace(value) {
  ...
  return {
    ...
    } : { objectives: {}, periodAssignments: [], academicPeriods: [], attendanceRecords: [] },
