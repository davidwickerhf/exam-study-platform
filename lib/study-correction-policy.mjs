...
export function outlineCorrectionStatus(draft) {
  ...
  return pending ? {corrections:pending.corrections,maxAttempts:pending.maxAttempts,exhausted:Boolean(pending.exhausted),error:pending.error,issues:pending.issues,omittedIssues:pending.overflow || 0} : null
}
