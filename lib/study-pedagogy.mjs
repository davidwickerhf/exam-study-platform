...
export const pedagogyReviewSchema = z.object({
  ...
  transferChecks: z.array(z.object({ questionKey:key, closestExampleSectionId:key.nullable(), changedCondition:prose, variation:z.enum(['copied','numbers_only','new_context','reverse_inference','combined_mechanisms','diagnosis','boundary_change']), rationale:prose })).max(24).default([]),
