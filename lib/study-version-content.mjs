...
export function parseStudyJson(raw, schema) {
  try {
    ...
    throw new StudyVersionError(
      'The generated response did not meet the study format. Retry this step.',
      502
    )
  }
}
