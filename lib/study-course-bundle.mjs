...
export const courseBundleOutlineSchema=z.object({
 guides:z.array(z.object({id:z.string().regex(/^[a-z0-9-]{1,70}$/),title:z.string().min(1).max(180),topics:outlineSchema.shape.topics})).min(2).max(MAX_BUNDLE_GUIDES),
...
export function bundleChapterBudget(capacity){
