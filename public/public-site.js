...
function docsPage() {
  ...
  return `${header('/docs')}<main id="main-content" class="legal-page docs-page">
    ...
    <div class="legal-layout"><nav aria-label="Docs sections"><a href="#start">Getting started</a><a href="#study">Studying</a><a href="#documents">Documents &amp; calendars</a><a href="#keys">API keys</a><a href="#skill">Claude skill</a><a href="#mcp">MCP server</a><a href="#api">HTTP API</a><a href="#security">Security</a><a href="#admin">Administrators</a></nav><article>
