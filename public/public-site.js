...
function header(active = '') {
  const links = [['/', 'Product'], ['/about', 'About'], ['/courses', 'Courses']]
...
function privacyPage() {
  return `${header('/privacy')}<main id="main-content" class="legal-page">
    ...
    <div class="legal-layout"><nav aria-label="Privacy notice sections"><a href="#controller">Controller</a><a href="#data">Data we process</a><a href="#purposes">Purposes and legal bases</a><a href="#providers">Service providers</a><a href="#retention">Retention</a><a href="#rights">Your rights</a><a href="#cookies">Cookies</a><a href="#contact">Contact</a></nav><article>
      ...
      <section id="data"><h2>2. Data we process</h2><ul><li><strong>Account data:</strong> account identifier, email address, authentication status, and account creation information supplied through Clerk.</li><li><strong>Study data:</strong> course ordering, progress, mastery, notes, attempts, answers, flashcards, mistake history, review schedules, and mock-session records.</li><li><strong>AI activity:</strong> tutor messages and exercise instructions, retrieved course passages, request counts, and input/output token totals. Account email addresses are not intentionally included in model prompts.</li><li><strong>Technical data:</strong> essential session data and security or service logs created by hosting and authentication providers.</li></ul><p>Shared course sources are editorial content and are stored separately from personal study records.</p></section>
...
export function mountPublicSite(pathname = '/') {
  ...
  const labels = { '/': 'Academic exam preparation', '/about': 'About', '/courses': 'Courses', '/privacy': 'Privacy notice', '/terms': 'Terms of service' }
