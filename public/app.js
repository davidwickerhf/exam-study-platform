  ...
  return `
    <aside class="sidebar">
      ...
      <nav>
        ...
        <a class="nav-tool ${route.page === 'planning' ? 'active' : ''}" href="#/planning" title="Academic planning"><span class="nav-icon tool-icon">${ICONS.stats}</span><span class="nav-label">Planning</span></a>
