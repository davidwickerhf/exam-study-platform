...
function bootSkeleton(message: string) {
  ...
  return `<div class="dash boot-shell" aria-busy="true" aria-live="polite">
    <aside class="dash-side"><div class="dash-brand"><img class="brand-mark" src="/brand-mark.svg" width="64" height="64" alt="" aria-hidden="true"><span class="dash-brand-text"><strong>Wicker Study</strong><small>Academic workspace</small></span></div>
