  ...
  return <main className={styles.page}>
    ...
    <div className={styles.layout}>
      <section className={styles.connection} aria-labelledby="canvas-connection-title">
        ...
        {connectionLoading ? <p className={styles.muted}>Checking your saved connection…</p> : remoteConnection ? <div className={styles.connectionState}><span className={styles.stateOk}><Icon name="check" /></span><div><strong>Connected to this Wicker account</strong><p>Encrypted at rest · last used {remoteConnection.lastUsedAt ? new Intl.DateTimeFormat(undefined, { dateStyle: 'medium' }).format(new Date(remoteConnection.lastUsedAt)) : 'not yet'}.</p><a className={styles.settingsLink} href="/app/settings?tab=connections">Manage Canvas connection</a></div></div> : <div className={styles.connectionState}><span className={styles.statePending}>1</span><div><strong>Connect Canvas in Settings</strong><p>Your Personal Access Token is managed once under your account, encrypted immediately, and never displayed again. This archive never asks for your password, OTP, cookies, or session.</p><a className={styles.settingsLink} href="/app/settings?tab=connections">Open Canvas settings</a></div></div>}
      </section>
