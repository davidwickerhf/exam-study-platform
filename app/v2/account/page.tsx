...
import { readJson, useJson } from "@/components/v2/use-json";
import { connectionOrigin } from "@/lib/v2/updates.mjs";
import {
  type AccountSummary,
  type Activity,
  type AiUsage,
    ...
    <div className="mx-auto flex w-full max-w-[1180px] flex-col gap-6 p-8">
      ...
      <Tabs
        ...
        onValueChange={(value) => {
          ...
          setTab(next);
          history.replaceState(null, "", `/v2/account?tab=${next}`);
        }}
        className="gap-6"
      >
        <TabsList>
