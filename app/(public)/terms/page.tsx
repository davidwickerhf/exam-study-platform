    ...
    <main id="main-content" className="legal-page">
      ...
      <div className="legal-layout">
        ...
        <article>
          ...
          <section id="content"><h2>4. Course and personal content</h2><p>Course materials and the platform interface remain protected by their applicable intellectual-property rights. You may use them for personal study within the service and may not redistribute, scrape, resell, or republish them without permission. You retain rights in personal notes and answers you create.</p><p>When you attach material to a course request, you confirm that you may lawfully access it and share it privately for this processing purpose. You permit Wicker Study to store, inspect, extract, and use the submission to evaluate and prepare the requested course. A submission does not by itself grant Wicker Study a right to publish or redistribute third-party material; publication remains subject to separate rights and editorial review. Do not submit another person’s private data, confidential assessment material, or content obtained by bypassing access controls.</p></section>
          <section id="ai"><h2>5. AI-assisted features</h2><p>AI is used for retrieval-grounded tutor chat, further exercises requested by the user, academic-plan extraction, and source-grounded preparation of requested course content under administrator review. Responses can be incomplete or incorrect and should be verified against cited course material. Usage limits protect service capacity and may be adjusted. Attempts to bypass limits or use AI endpoints outside their intended study purpose are prohibited.</p></section>
