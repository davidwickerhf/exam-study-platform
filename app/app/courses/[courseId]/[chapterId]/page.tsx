...
import { type StudyCourse, readKey } from '@/lib/workspace/courses.mjs'
    ...
    <div className="mx-auto grid w-full max-w-[1400px] gap-10 p-8 lg:grid-cols-[minmax(0,1fr)_220px]">
      <article className="mx-auto w-full max-w-[74ch] min-w-0">
        <header className="flex flex-col gap-2 border-b pb-5">
          <Link href={`/app/courses/${params.courseId}`} className="text-muted-foreground hover:text-foreground inline-flex w-fit items-center gap-1.5 text-xs font-semibold">
