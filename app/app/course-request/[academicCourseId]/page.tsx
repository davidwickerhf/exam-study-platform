...
export default function CourseRequestPage() {
  ...
  return <div className="mx-auto flex w-full max-w-[1180px] flex-col gap-8 p-5 sm:p-8">
    ...
    <ConfirmDialog open={withdrawOpen} onOpenChange={setWithdrawOpen} title="Withdraw shared-use permission?" description="The request stays open and its sources remain private, but the editorial team can no longer consider them for shared course material." confirmLabel="Withdraw permission" destructive busy={busy} onConfirm={() => { setWithdrawOpen(false); void withdraw(); }} />
  </div>;
}
