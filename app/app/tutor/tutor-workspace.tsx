...
export type TutorContext = {
  ...
  selection?: {kind: 'document' | 'question'; title: string; text?: string; sourceAssetId?: string; page?: number} | null
