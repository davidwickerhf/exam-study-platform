...
type Message = { presentation?: TutorPresentation; role: 'user' | 'assistant'; content: string; at?: string; evidence?: Evidence[]; proposals?: Proposal[]; context?: TutorContext | null }
...
function Answer({ message, onReview }: { message: Message; onReview: (ids: string[]) => void }) {
