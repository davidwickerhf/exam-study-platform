...
import { ArrowLeftIcon, ArrowRightIcon, RefreshCwIcon, ShareIcon, LibraryIcon } from 'lucide-react'
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-1 text-sm">
              {version.course.courseName} · {local ? 'Generated by your local agent · Not independently reviewed' : 'Personal generation, not editorially reviewed'}
            </p>
          </div>
