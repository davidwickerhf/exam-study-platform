...
import { searchable, searchHref, searchLabel } from '../lib/workspace/search.mjs'
...
test('a result points to its migrated chapter and optional heading', () => {
  assert.equal(searchHref('math/1', { chapterId: '2', headingSlug: 'sets & maps' }), '/app/courses/math%2F1/2#sets%20%26%20maps')
})
